...
export default function CustomersTable({
  ...
  return (
    <div className="w-full">
      <h1 className={`${lusitana.className} mb-8 text-2xl md:text-3xl text-center text-pink-800`}>
        Clientes
      </h1>
      ...
      <div className="mt-6 flow-root">
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden rounded-lg bg-white shadow-lg p-4 md:p-6">
              ...
              <table className="hidden min-w-full rounded-lg text-gray-900 md:table">
                ...
                <tbody className="divide-y divide-pink-200 text-gray-900">
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group hover:bg-pink-50 transition-colors duration-200">
