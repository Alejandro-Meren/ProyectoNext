...
export default function LoginForm() {
  ...
  return (
    <form action={formAction} className="space-y-6 bg-white p-8 rounded-lg shadow-lg mt-16">
      <div className="flex flex-col items-center">
        <h1 className={`${lusitana.className} mb-6 text-3xl text-center text-pink-600`}>
          Welcome Back!
        </h1>
      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input
            className="peer block w-full rounded-md border border-gray-300 py-3 pl-10 pr-4 text-sm outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 placeholder:text-gray-500"
            id="email"
            type="email"
            name="email"
      ...
      <Button className="mt-6 w-full bg-pink-500 text-white py-3 rounded-lg shadow-md hover:bg-pink-600 transition-colors duration-300 flex items-center justify-center" aria-disabled={isPending}>
